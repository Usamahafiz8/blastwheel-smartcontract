...
const ObjectDigest = import_bcs.bcs.byteVector().transform({
  name: "ObjectDigest",
...
const CallArg = import_bcs.bcs.enum("CallArg", {
  Pure: import_bcs.bcs.struct("Pure", {
    bytes: import_bcs.bcs.byteVector().transform({
...
const Command = import_bcs.bcs.enum("Command", {
  ...
  Publish: import_bcs.bcs.struct("Publish", {
    modules: import_bcs.bcs.vector(
      import_bcs.bcs.byteVector().transform({
        input: (val) => typeof val === "string" ? (0, import_bcs.fromBase64)(val) : val,
        output: (val) => (0, import_bcs.toBase64)(new Uint8Array(val))
      })
    ),
...
const CompressedSignature = import_bcs.bcs.enum("CompressedSignature", {
  ED25519: import_bcs.bcs.bytes(64),
  Secp256k1: import_bcs.bcs.bytes(64),
  Secp256r1: import_bcs.bcs.bytes(64),
  ZkLogin: import_bcs.bcs.byteVector(),
  Passkey: import_bcs.bcs.byteVector()
});
const PublicKey = import_bcs.bcs.enum("PublicKey", {
  ED25519: import_bcs.bcs.bytes(32),
  Secp256k1: import_bcs.bcs.bytes(33),
  Secp256r1: import_bcs.bcs.bytes(33),
  ZkLogin: import_bcs.bcs.byteVector(),
  Passkey: import_bcs.bcs.bytes(33)
});
...
const base64String = import_bcs.bcs.byteVector().transform({
  input: (val) => typeof val === "string" ? (0, import_bcs.fromBase64)(val) : val,
  output: (val) => (0, import_bcs.toBase64)(new Uint8Array(val))
});
...
const PasskeyAuthenticator = import_bcs.bcs.struct("PasskeyAuthenticator", {
  authenticatorData: import_bcs.bcs.byteVector(),
  clientDataJson: import_bcs.bcs.string(),
  userSignature: import_bcs.bcs.byteVector()
});
